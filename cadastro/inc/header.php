...
<body>
  <div class="page">
    ...
    <!-- Unified Top Navbar -->
    <header class="navbar navbar-expand-md navbar-light app-header d-print-none sticky-top">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item d-none d-md-block">
                <a class="nav-link <?= $navActive['refunds'] ? 'active' : '' ?>" href="/refunds/index.php" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><i class="ti ti-receipt-refund"></i></span>
